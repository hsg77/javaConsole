...
public class GeoServerUtil {
    ...
    static {
        RESTURL = getenv("gsmgr_resturl", "http://192.168.30.114:8080/geoserver/");
    ...
    public  static boolean  publishShpAndReloadStore(String workspace,String zipFilePath,String storeName,String layerName,String styleType,String coordinateSystem) throws  Exception{
        ...
        boolean published;
        if(Constant.AtlasType.ATLAS_TYPE_5.equals(styleType)){
    ...
    public static boolean removeLayer(String workspace,String storeName){
        return publisher.removeLayer(workspace,storeName);
    }
    public static boolean createWorkspace(String ws){
        return publisher.createWorkspace(ws);
    }
    public  static boolean removeDatastore(String workspace, String storename)
    {
        return publisher.removeDatastore(workspace,storename,true);
    }
    public static boolean createDatastore(String workspace, String storename,String layername,String srs,String defaultStyle)
    {
